...
from snemovna.PoslanciOsoby import Organy
from snemovna.TabulkySchuze import TabulkaSchuzeMixin, TabulkaSchuzeStavMixin, TabulkaBodSchuzeMixin, TabulkaBodStavMixin
